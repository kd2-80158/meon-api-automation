...
/**
 * Thread-safe ExtentReporter utility that prevents duplicate ExtentTest
 * creation. Usage: -
 ...
 *
 * Note: For de-dup to work reliably, pass a stable uniqueId (e.g.
...
public final class ExtentReporterUtility {
	...
	/**
	 * Initialize Extent spark reporter with given path. Call once in your
	...
	/**
	 * Create or return an existing ExtentTest identified by uniqueId. Display name
	 * is used for the visible label in the report.
	 *
	 * @param uniqueId    stable identifier for the test (eg:
	...
	/**
	 * Backwards-compatible overload (uses displayName as unique id). Prefer the
	 * (uniqueId, displayName) overload to avoid collisions.
	 */
	...
	/**
	 * Small helper used by your TestListener to produce a short summary subject
	 * string. Example output: "API Test - Tests: total=42, passed=40, failed=1,
	 * skipped=1"
	 */
